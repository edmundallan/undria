	...
	<div class="feature-section two-col">
		<div class="col">
			...
			<?php if ( $this->jetpack_is_recommended() ) : ?>
				<h3><?php esc_html_e( 'Connect Your Site To Jetpack', 'greentech-lite' ); ?></h3>
				<p>
					<?php
				...
				<a class="button" href="<?php echo esc_url( admin_url( 'themes.php?page=jetpack#/dashboard' ) ); ?>"><?php esc_html_e( 'Connect To Jetpack', 'greentech-lite' ); ?></a>
			<?php endif; ?>
		</div>
	</div>
</div>
